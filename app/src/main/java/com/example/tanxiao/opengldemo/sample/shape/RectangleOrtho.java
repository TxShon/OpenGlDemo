...
public class RectangleOrtho implements IShape {
    ...
    public RectangleOrtho(Context context) {
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        int programHandle = GlCommonUtil.createProgram(
                GlCommonUtil.readShaderFromSource(context, R.raw.simple_vertex_shader_ortho)
                , GlCommonUtil.readShaderFromSource(context, R.raw.simple_fragment_shader_ortho));

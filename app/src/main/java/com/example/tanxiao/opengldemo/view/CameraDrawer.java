...
//            "  gl_FragColor = vec4(fGrayColor, fGrayColor, fGrayColor, 1.0);\n" +
    ...
    private void initGl() {
        ...
        mTextureCoordHandle = GLES20.glGetAttribLocation(mProgramHandle, "vTextureCoord");
        mMVPMatrixHandle = GLES20.glGetAttribLocation(mProgramHandle, "uTextureMatrix");
        mTextureHandle = GLES20.glGetAttribLocation(mProgramHandle, "uTextureSampler");
    ...
    public void draw(float[] mtx) {
        ...
        GLES20.glVertexAttribPointer(mProgramHandle, 2, GLES20.GL_FLOAT, false,
                2 * BYTES_PER_FLOAT, positionBuffer);
        GLES20.glEnableVertexAttribArray(mProgramHandle);
